...
namespace Dustuu.VRChat.Uutils.MenuuSystem
{
    public class MenuScrollView : UdonSharpBehaviour
    {
        ...
        public ScrollRect GetScrollRect() { return GetComponent<ScrollRect>(); }
        public RectTransform GetContentRoot() { return GetScrollRect().content; }
        ...
        public void ResetScrollRect()
        {
            ...
            GetContentRoot().GetComponent<RectTransform>().localPosition = Vector3.zero;
        }
    }
}